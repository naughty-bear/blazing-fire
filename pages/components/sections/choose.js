    ...
    return (
        <section className='bg-black relative '>
            ...
            <div className='max-w-screen-xl mx-auto pt-32 relative z-10 px-4'>
                ...
                {/* 内容区域 */}
                <div className='flex flex-row text-white text-xl lg:mt-10 Flex text-center '>
                    {/* 左 */}
                    <div className='lg:w-1/3 md:w-2/5 mt-10 flex flex-col'>
                    ...
                    <div clssName='mx-auto lg:w-1/3 md:w-1/5'>
                        <img src='/images/banner.png' className='lg:max-w-xl  mr-10 mx-auto'></img>
                    </div>
                    {/* 右 */}
