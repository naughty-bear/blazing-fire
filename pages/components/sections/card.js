...
export default function Cord(){
    return (
        <ul className='flex mx-auto lg:flex-row sm:flex-col pt-20 max-w-screen-xl'>
            <li>
                <div className="card w-80 h-96 text-white text-center shadow-xl pt-20 bg-gradient-to-b from-pink-600 to-blue-500 ">
                    ...
                    <div className="card-body text-center">
                        <h2 className="card-title text-center">360 Photography/Video</h2>
                        <p>Precision 360 images/video shot at 4-8K as standard. A rig for every occasion.</p>
                    </div>
                </div>
            </li>
            <li>
                <div className="card w-80 h-96 text-white text-center shadow-xl pt-10">
                    <figure><img src="/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Shoes" /></figure>
                    <div className="card-body text-center">
                        <h2 className="card-title">360 Virtual Tour!</h2>
            ...
            <li>
                <div className="card w-80 h-96 text-white text-center  shadow-xl bg-gradient-to-b from-pink-600 to-blue-500 pt-20">
                    <figure><img src="/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Shoes" /></figure>
                    <div className="card-body text-center">
                        <h2 className="card-title">Immersive & Interactive Experience</h2>
            ...
            <li>
                <div className="card w-80 h-96 text-white text-center shadow-xl pt-10">
                    <figure><img src="/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Shoes" /></figure>
                    <div className="card-body text-center">
                        <h2 className="card-title">Metaverse Development!</h2>
