        ...
        <img src='/images/background/ormanents02.png' className='absolute z-0 w-2/4 -top-32'></img>
            <div className='max-w-screen-xl mx-auto flex flex-row py-20 relative z-10 '>
                ...
                <div className='w-3/5 flex flex-row flex-wrap relative mt-20'>
                    ...
                    <img src='/images/icon/视频播放.png' className='w-20 absolute top-72 right-96 bttn'></img>
                </div>
                {/* 右侧 */}
                <div className='w-2/5 pl-10'>
                    ...
                    <div>
                        <ul >
                            ...
                            <li className='mt-6  ml-20'>
                                <h3 className='text-xl text-white'>Do you have an estimated Sq Ft of the space?</h3>
                                <p className='text-sm mt-2 text-gray-400 absolute '>If not do you have any photos of the space you can share so your provider can get a feel for the size and shape</p>
                            </li>
                            <li className='mt-6'>
