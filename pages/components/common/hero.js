    ...
    return (
        <div className='bg-black pb-20 relative'>
            ...
            <div className=" flex flex-row Flex-r px-4  max-w-screen-xl  mx-auto  py-24 relative z-10 ">
                <div className='pt-24 md:w-1/2  Margin-T'>
                ...
                <div className="relative md:w-1/2 mt-30 w-2/3 mx-auto">
                    ...
                    <img src='/images/banner-3.png' className='absolute top-16 left-12 w-64 z-10 rounded-xl img2'></img>
                    <img src='/images/elements01.png' className='absolute top-32 right-16 w-24 z-50 '></img>
                    <img src='/images/elements02.png' className='absolute top-96 left-8 w-28 z-50  lg:block hidden'></img>
