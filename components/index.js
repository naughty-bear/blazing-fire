export default {
    ...
    section: {
        ...
        features: {
            backgroundColor:
                'linear-gradient(91deg, #3B387C 0%, #1D1C37 100%, #1D1C37 100%)',
            pt: [7, 7, 7, 7, 8],
            pb: [7, 7, 7, 7, 8],
        },
        introVideo: {
