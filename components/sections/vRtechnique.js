...
export default function vRtechnique() {
    return (
        <section className='w-screen bg-black relative'>
            ...
            <div className='max-w-screen-xl mx-auto flex flex-row py-20 px-4  z-10 Flex '>
                {/* 左侧 */}
                <div className='lg:w-3/5 md:w-2/4 flex flex-row flex-wrap relative mt-20 animate__animated animate__slideInRight'>
                    <img src='/images/banner-4.png' className='md:w-96 h-80 md:absolute top-6 mr-8 Width z-10'></img>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className='w-20 rounded-full absolute top-1/2 left-1/3 md:top-1/3 bttn  z-10  animate-pulse bg-purple-500 opacity-60'>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 11.672a.375.375 0 010 .656l-5.603 3.113a.375.375 0 01-.557-.328V8.887c0-.286.307-.466.557-.327l5.603 3.112z" />
                    </svg>
                </div>
                {/* 右侧 */}
                <div className='lg:w-2/5 md:w-2/4 pl-4 Margin-t animate__animated animate__slideInLeft '>
                    ...
                    <div>
                        <ul >
                            <li className='mt-6 flex flex-row card w-full'>
                                <figure className='text-pink-500 w-16 h-16 mr-2 rounded-full bg-gray-400 opacity-20 my-auto'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
                            ...
                            <li className='mt-6 flex flex-row card'>
                                <figure className='text-blue-500 w-16 h-16 mr-2 rounded-full bg-gray-400 opacity-20 my-auto'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
